...
export default function RegisterPage() {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      login(user, token)
      toast.success('Staff account created! Welcome. 🛡️')
      navigate(
    ...
    <div className="auth-page">
      ...
      <div className="auth-hero">
        ...
        <div className="auth-hero__content">
          ...
          <h1 className="auth-hero__system">Join the<br/>SVSS Team</h1>
          <p className="auth-hero__tagline">
            Create your staff account to start managing venue security operations.
          </p>
      ...
      <div className="auth-form-panel">
        <div className="auth-card" style={{ maxWidth: 480 }}>
          <p className="auth-card__eyebrow">Staff Registration</p>
          <h2 className="auth-card__title">Create staff account</h2>
          <p className="auth-card__sub">For Administrators and Security Staff only.</p>
          ...
          <form onSubmit={handleSubmit(onSubmit)} noValidate className="auth-form">
            ...
            <Input id="reg-email" label="Email Address" type="email" placeholder="you@svss.io"
            ...
            <Select id="role" label="Staff Role" required error={errors.role?.message}
          ...
          <div className="auth-portal-switch">
            ...
            <Link to="/customer/register" className="auth-portal-switch__link">
